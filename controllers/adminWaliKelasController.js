...
exports.actionCreateNilaiSikap = async (req, res) => {
  ...
  for (let i = 0; i < nilai_sikap.length; i++) {
    if (n_sosial[i] === "A") {
      ket_sosial = " A = selalu bersikap santun pada orang lain, peduli pada sesama teman, memiliki kepercayaan diri yang baik, responsif dalam pergaulan, memiliki sikap jujur, disiplin, dan tanggungjawab yang tinggi."
    } else if (n_sosial[i] === "B") {
      ket_sosial = " B = memiliki sikap santun pada orang lain, peduli pada sesama teman, memiliki kepercaya diri yang baik, cukup responsif dalam pergaulan, memiliki sikap jujur, disiplin, dan tanggungjawab yang cukup tinggi."
    } else if (n_sosial[i] === "C") {
      ket_sosial = " C = memiliki sikap yang cukup santun pada orang lain, cukup peduli pada sesama teman, memiliki kepercayaan diri yang cukup baik, responsif dalam pergaulan, memiliki sikap jujur, cukup disiplin, dan tanggungjawab yang cukup baik."
    } else if (n_sosial[i] === "D") {
      ket_sosial = " D = sering bersikap kurang santun pada orang lain, kurang peduli pada sesama teman, kepercayaan diri kurang baik , tidak responsif dalam pergaulan, kurang memiliki sikap jujur, disiplin, dan tanggungjawab yang rendah."
    }

    if (n_spiritual[i] === "A") {
      ket_spiritual = " A = selalu bersyukur dan berdoa sebelum melakukan kegiatan serta memiliki toleran yang sangat tinggi pada pemeluk agama yang berbeda, ketaatan beribadah sangat baik dan selalu mengingatkan teman-temannya untuk melaksanakan ajaran agamanya dengan baik."
    } else if (n_spiritual[i] === "B") {
      ket_spiritual = " B = selalu bersyukur dan berdoa sebelum melakukan kegiatan serta memiliki toleran yang tinggi pada pemeluk agama yang berbeda, ketaatan beribadah baik dan sering mengingatkan teman-temannya untuk melaksanakan ajaran agamanya dengan baik."
    } else if (n_spiritual[i] === "C") {
      ket_spiritual = " C = selalu bersyukur dan berdoa sebelum melakukan kegiatan serta memiliki toleran yang cukup tinggi pada pemeluk agama yang berbeda, ketaatan beribadah mulai berkembang dari waktu ke waktu."
    } else if (n_spiritual[i] === "D") {
      ket_spiritual = " D = selalu bersyukur dan berdoa sebelum melakukan kegiatan akan tetapi memiliki sikap kurang toleran pada pemeluk agama yang berbeda, ketaatan beribadah masih belum menunjukan perkembangan yang baik."
    }
...
exports.viewSemester = async (req, res) => {
  try {
    const userLogin = req.session.user;
    ...
    const semester = await kelompok_wali_kelas.findOne({
      where: {
        GuruId: { [Op.eq]: guru.id }
      },
      include: [
...
exports.viewCetakRaport = async (req, res) => {
      ...
      kelompok_wali_kelas.findOne({
        ...
        if (cek_rangking.length > 0) {
          ...
          for (var i = 0; i < cek_rangking.length; i++) {
            ...
            if (cek_rangking[i].SiswaId == siswa.SiswaId) {
